...
public class LatestSightingItemDetailsActivity extends Activity {

	private boolean webAccess;
	private int tabId;
	private ShareActionProvider shareActionProvider;
	private LatestSightingItem item;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_latest_sighting_item_details);
		...
		String title = b.getString(Constants.SELECTED_SIGHTING_ITEM);
		this.webAccess = b.getBoolean(Constants.WEB_ACCESS);
		this.tabId = b.getInt(Constants.ARG_SECTION_NUMBER);
		
		this.item = LatestSightingManager.getSightingItem(title);

		LinearLayout ll = (LinearLayout) findViewById(R.id.latestSightingItemDetails);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.latest_sighting_item_details, menu);
		
        // Locate MenuItem with ShareActionProvider
        MenuItem item = menu.findItem(R.id.menu_item_share_sighting_item);
	    ...
	    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "IWDG Sighting Item");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                //Intent upIntent = new Intent(this, LatestSightingsFragment.class);
